...
public class PersonController {
		...
		@Autowired
		private PagedResourcesAssembler<PersonVO> assembler; //injeção de dependencia 
		...
		public ResponseEntity<?> findAll(@RequestParam(value = "page", defaultValue = "0") int page,
									  ...
									  ){ // o spring adiciona o assembler como param automaticamente
			...
			PagedResources<?> resources = assembler.toResource(persons); //montará a pagina
			
			
			return new ResponseEntity<>(resources,HttpStatus.OK); //retorna a response entity de acordo com o assembler que o springboot seta a partir da lista persons que nós enviamos
		...
		public ResponseEntity<?> findPersonByName(
				...
				){ //adicionamos este param para realizar o assembling da pagina, o spring que injeta essa instancia, nao precisamos passar esse param
